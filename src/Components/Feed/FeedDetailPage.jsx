...
const Loader = () => {
    return (
        <div className="min-h-[75vh] rounded-lg flex flex-col items-center justify-start w-full animate-pulse bg-base-300">
...
const FeedDetailPage = () => {
    ...
    const {
        activityState: { loading: loadingActivity },
        dispatchActivity,
    } = useActivityContext();
    ...
    const archiveHandlerFunction = () => {
        ...
        archiveActivity(archiveType, dispatchActivity, feed, () =>
            setFeed((prev) => ({ ...prev, is_archived: !isArchive }))
        );
    };
                ...
                if (loading) return <Loader />;
                    ...
                    return (
                        <Fragment>
                            <div className="m-8">
                                <h2
                                    className="flex flex-row gap-1 text-xxl cursor-pointer my-3 hover:text-indigo-700"
                                ...
                                <div className="bg-secondary shadow-sm p-3 rounded-md flex flex-row items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        onClick={archiveHandlerFunction}
